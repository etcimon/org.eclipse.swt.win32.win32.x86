...
static void blit(int op,
    ...
    if ((destReds !is null) && (destReds.length < destPaletteSize)) destPaletteSize = cast(int) destReds.length;
    ...
    switch (alphaMode) {
        ...
        case ALPHA_MASK_RGB:
            ...
            if ((srcReds !is null) && (srcReds.length < srcPaletteSize)) srcPaletteSize = cast(int) srcReds.length;
